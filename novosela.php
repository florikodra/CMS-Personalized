...
<html>
	<head>
		...
		<title>Produkte Shqiptare | Novosela</title>
...
<?php }?>
						...
						<div class="container">
							...
							<div class="portfolio-masonry-wrapper" data-col="three" data-gutter="60">
								...
								<div class="portfolio-list"><?php							$search=mysql_query("SELECT * FROM produkt WHERE vendodhje LIKE '%novosele%'")or die (mysql_error());
